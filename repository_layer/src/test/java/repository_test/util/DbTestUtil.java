...
//    }
//
//    public void fillTables(JdbcTemplate jdbcTemplate) {
//
//        createEntities();
//
////        em.persist(gc1);
...
//    }
//
//    public void dropTables(JdbcTemplate jdbcTemplate) {
//
...
//                LocalDateTime.MAX.truncatedTo(ChronoUnit.MILLIS), List.of(tag2, tag22));
//        gc3Spare = new GiftCertificate(3L, "33", "333", 3333, 33333, LocalDateTime.now().truncatedTo(ChronoUnit.MILLIS),
//                LocalDateTime.now().truncatedTo(ChronoUnit.MILLIS), List.of());
//    }
//}
